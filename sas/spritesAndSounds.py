...
playerStrectchedImage = pygame.transform.scale(playerImage, (40,40))
...
while True:
    ...
    windowSurface.blit(playerStrectchedImage, player)
    ...
    for food in foods[:]:
        if player.colliderect(food):
            ...
            playerStrectchedImage = pygame.transform.scale(playerImage, (player.width,player.height))
            if musicPlaying:
                pickUpSound.play()
